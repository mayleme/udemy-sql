...
/* ACERTANDO OS DADOS DE SEXO CORRETAMENTE */

UPDATE CLIENTE SET SEXO = 'F' WHERE IDCLIENTE IN (6,12,13,14,18,19);
...
AND CLIENTE.SEXO='F'
AND (TELEFONE.TIPO='COM' OR TELEFONE.TIPO='RES');
...
SELECT C.NOME, C.EMAIL, T.TIPO, T.NUMERO
FROM CLIENTE C
	INNER JOIN TELEFONE T
	ON C.IDCLIENTE=T.ID_CLIENTE
	INNER JOIN ENDERECO E
